...
public class Pathfinding : MonoBehaviour {
	...
	private void Start() {
		...
		List<TileType> topNeighbour = new List<TileType> (){TileType.Horizontal, TileType.BottomLeft, TileType.BottomRight };
		...
		List<TileType> bottomNeighbour = new List<TileType> (){ TileType.Horizontal, TileType.TopLeft, TileType.TopLeft };
